...
import upstoxsrc from "./images/upstox_logo.svg";
import kitesrc from "./images/kiteLogo.svg";
              ...
              <div>
                ...
                <div className="description">
                  <p>
                    ...
                    lakh crores of equity investments and contribute to 15% of
              ...
              <div className="button-grid">
                <Button className="button" type="primary" onClick={login}>
                  <div className="button-content">
                    <img src={upstoxsrc} alt="Upstox" />
                    <div>Upstox</div>
                  </div>
                </Button>
                <Button className="button" type="primary">
                  <div className="button-content">
                    <img src={kitesrc} alt="Zerodha" />
                    <div>Zerodha</div>
                  </div>
                </Button>
                <Button className="button" type="primary">
                  <div className="button-content">
                    <img
                      src={require("./images/angelOne.png")}
                      alt="Angel One"
                    />
                    <div>Angel One</div>
                  </div>
                ...
                <Button className="button" type="primary">
                  <div className="button-content">
                    <img
                      src={require("./images/iciciLogo.png")}
                      alt="Icici Direct"
                    />
                ...
                <Button className="button" type="primary">
                  <div className="button-content">
                    <img
                      src={require("./images/5paisaLogoNew.png")}
                      alt="5Paisa"
                    />
                    <div>5Paisa</div>
                  </div>
                ...
                <Button className="button" type="primary">
                  <div className="button-content">
                    <img src={require("./images/iiflLogo.png")} alt="IIFL" />
                    <div>IIFL</div>
                  </div>
                </Button>
              </div>
